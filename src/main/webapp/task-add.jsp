        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <c:if test="${param.msg == 'created'}">
					<div class="alert alert-success">Thêm task thành công!</div>
				</c:if>
				<c:if test="${param.msg == 'failed'}">
					<div class="alert alert-warning">Thêm task thất bại!</div>
				</c:if>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form method="post" action="${ctx}/task-add" class="form-horizontal form-material">
                            
                            	<!-- Chon du an - job -->
                                <div class="form-group">
							        <label class="col-sm-12">Select Job</label>
							        <div class="col-sm-12">
							            <!--  name=job_id, thường load từ DB -->
                                ...
                                <div class="form-group">
							        <label class="col-sm-12">Nguoi thuc hien</label>
							        <div class="col-sm-12">
							            <!--  name=user_id, thường load từ DB -->
							            <select name="user_id" class="form-control form-control-line" required>
							                <option value="">-- Nguoi thuc hien --</option>
