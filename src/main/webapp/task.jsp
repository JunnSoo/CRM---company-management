            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
                        <a href="${ctx}/task-add" class="btn btn-sm btn-success">Thêm mới</a>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <c:if test="${not empty param.msg}">
	                ...
	                " role="alert" style="margin-top:10px;">
	                    <c:choose>
	                        <c:when test="${param.msg eq 'created'}">Them task thành công.</c:when>
	                        <c:when test='${param.msg eq "updated"}'>Cập nhật task thành công.</c:when>
	                        <c:when test='${param.msg eq "deleted"}'>Xóa task thành công.</c:when>
	                        ...
	                        <c:when test='${param.msg eq "not_found"}'>Không tìm thấy task</c:when>
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach var="t" items="${listTask}" varStatus="st">
                                            <tr>
                                                ...
                                                <td>${t.statusName}</td>
                                                <td>
                                                    <a href="${ctx}/task-edit?id=${t.id}" class="btn btn-sm btn-primary">Sửa</a>
                                                    <a href="${ctx}/task-delete?id=${t.id}" class="btn btn-sm btn-danger"
                                                    onclick="return confirm('Bạn chắc chắn muốn xóa task này?');">
                                                    Xóa
                                                    </a>
                                                    <a href="${ctx}/task-details?id=${t.id}" class="btn btn-sm btn-info">Xem</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
